...
class VKLoginProvider extends BaseLoginProvider {
    ...
    signIn(permissions) {
        if (permissions === null || permissions === void 0 ? void 0 : permissions.includes('offers')) {
            console.warn('The "offers" permission is outdated.');
        }
        if (permissions === null || permissions === void 0 ? void 0 : permissions.includes('questions')) {
            console.warn('The "questions" permission is outdated.');
        }
        if (permissions === null || permissions === void 0 ? void 0 : permissions.includes('messages')) {
            console.warn('The "messages" permission is unavailable for non-standalone applications.');
        }
        const scope = permissions === null || permissions === void 0 ? void 0 : permissions.reduce((accumulator, current) => {
...
GoogleSigninButtonDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.4.0", ngImport: i0, type: GoogleSigninButtonDirective, deps: [{ token: i0.ElementRef }, { token: SocialAuthService }], target: i0.ɵɵFactoryTarget.Directive });
...
GoogleSigninButtonModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.4.0", ngImport: i0, type: GoogleSigninButtonModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
GoogleSigninButtonModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.4.0", ngImport: i0, type: GoogleSigninButtonModule, declarations: [GoogleSigninButtonDirective], exports: [GoogleSigninButtonDirective] });
GoogleSigninButtonModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.4.0", ngImport: i0, type: GoogleSigninButtonModule });
