        ...
        this.loadScript(
          ...
          () => {
            ...
            google.accounts.id.initialize({
              ...
              prompt_parent_id:
                (_a = this.initOptions) === null || _a === void 0
                  ? void 0
                  : _a.prompt_parent_id,
    ...
    return new Promise((resolve, reject) => {
      ...
      if (!this._tokenClient) {
        ...
        this._tokenClient.requestAccessToken({
          hint:
            (_a = this._socialUser.value) === null || _a === void 0
              ? void 0
              : _a.email,
        });
...
SocialAuthService.ERR_NOT_INITIALIZED =
  "Login providers not ready yet. Are there errors on your console?";
SocialAuthService.ERR_NOT_SUPPORTED_FOR_REFRESH_TOKEN =
  "Chosen login provider is not supported for refreshing a token";
SocialAuthService.ERR_NOT_SUPPORTED_FOR_ACCESS_TOKEN =
...
SocialLoginModule.ɵfac = i0.ɵɵngDeclareFactory({
  ...
  deps: [{ token: SocialLoginModule, optional: true, skipSelf: true }],
          ...
          try {
            const config = {
              auth: {
                ...
                redirectUri:
                  (_a = this.initOptions.redirect_uri) !== null && _a !== void 0
                    ? _a
                    : location.origin,
      ...
      if (
        ...
        yield this._instance.logoutPopup({
          ...
          postLogoutRedirectUri:
            (_b =
              (_a = this.initOptions.logout_redirect_uri) !== null &&
              _a !== void 0
                ? _a
                : this.initOptions.redirect_uri) !== null && _b !== void 0
              ? _b
              : location.href,
        });
      }
...
GoogleSigninButtonDirective.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: "12.0.0",
  version: "13.4.0",
  type: GoogleSigninButtonDirective,
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: function () {
    return [{ type: i0.ElementRef }, { type: SocialAuthService }];
  },
  propDecorators: {
    type: [
      {
...
GoogleSigninButtonModule.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: "12.0.0",
  version: "13.4.0",
  ngImport: i0,
...
GoogleSigninButtonModule.ɵmod = i0.ɵɵngDeclareNgModule({
  minVersion: "12.0.0",
  version: "13.4.0",
  ngImport: i0,
  type: GoogleSigninButtonModule,
...
GoogleSigninButtonModule.ɵinj = i0.ɵɵngDeclareInjector({
  minVersion: "12.0.0",
  version: "13.4.0",
  ngImport: i0,
  type: GoogleSigninButtonModule,
